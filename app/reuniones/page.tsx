...
import { ResponseAllTutors } from "../tutores/interfaces/response-all-tutors.interface";
...
const Reuniones: React.FC = () => {
  ...
  const toTutorOption = (tutor: ResponseAllTutors): OptionItem => ({
    id: tutor.user.id,
    label: `${tutor.user.name} ${tutor.user.lastName}`.trim(),
  });
